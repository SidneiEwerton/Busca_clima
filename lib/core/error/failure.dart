...
class CityNotFoundException extends Failure{
  const CityNotFoundException():super('Cidade não encontrada. Verifique o nome ');
}

class ApiKeyInvalidFailure extends Failure{
  const ApiKeyInvalidFailure():super('Falha na autenticação com a API. Contate o suporte');
